...
// Retrives the fields that user already filled
session_start();
$position_id = isset($_SESSION["positionID"]) ? $_SESSION["positionID"] : "";
$title = isset($_SESSION["title"]) ? $_SESSION["title"] : "";
$description = isset($_SESSION["description"]) ? $_SESSION["description"] : "";
$closing_date = isset($_SESSION["closingDate"]) ? $_SESSION["closingDate"] : date('d/m/y');
$position = isset($_SESSION["position"]) ? $_SESSION["position"] : "";
$contract = isset($_SESSION["contract"]) ? $_SESSION["contract"] : "";
$location = isset($_SESSION["location"]) ? $_SESSION["location"] : "";
$application_by = isset($_SESSION["applicationBy"]) ? $_SESSION["applicationBy"] : [];
    ...
    <section class="card">
      ...
      <form action="postjobprocess.php" method="POST" class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" id="title" name="title" maxlength="10" placeholder="For example: Backend" value="<?php echo htmlspecialchars($title); ?>">
        </div>
        <div class="form-group">
