    ...
    <section class="card">
      ...
      <form action="searchjobprocess.php" method="GET" class="form-grid">
        <div class="form-group full-width">
          ...
          <input type="text" id="title" name="title" placeholder="Frontend, DevOps, Backend, ...">
        </div>
        <p class="hint"><i class="fa-solid fa-lightbulb" style="color: #FFD43B;"></i><strong>Most look-up keywords:</strong> WebDev, Frontend, BackendDev,...</p>
